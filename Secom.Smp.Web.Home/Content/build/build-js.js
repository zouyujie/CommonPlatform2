...
({
   ...
   //不符合AMD规范的js定义以及依赖关系配置
    ...
    {
       name: 'views/areas/admin/ECharts/index',
	   exclude: ['config']
    },
    {
       name: 'views/areas/admin/ECharts/Line',
	   exclude: ['config']
    },
    {
       name: 'views/areas/admin/EquKeep/index',
	   exclude: ['config']
    },
    {
       name: 'views/areas/admin/FileUpload/index',
	   exclude: ['config']
    },
    {
       name: 'views/areas/admin/KeepPlan/index',
	   exclude: ['config']
    },
    {
       name: 'views/areas/admin/RepairsList/index',
	   exclude: ['config']
    },
    {
       name: 'views/areas/History/Log/create',
	   exclude: ['config']
    },
    {
    ...
    {
       name: 'views/areas/History/Log/update',
	   exclude: ['config']
    },
    {
